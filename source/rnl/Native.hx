...
class Native
{
	public static inline function buf(size:Int):Bytes
		return Bytes.alloc(size);

	#if hl
	public static inline function data(b:Bytes):hl.Bytes
		return b.getData();

	public static inline function charData(b:Bytes):hl.Bytes
		return b.getData();
	...
	public static inline function readPtr(p:cpp.Star<cpp.Void>, len:Int):Bytes
	{
		...
		if (len > 0)
			untyped __cpp__('memcpy({0}->b->GetBase(), {1}, {2})', b, p, len);
		return b;
	}
	#end

	public static inline function mkI64(lo:Int, hi:Int):Int64
		return Int64.make(hi, lo);

	public static inline function lo(v:Int64):Int
		return v.low;

	public static inline function hi(v:Int64):Int
		return v.high;

	public static inline function getU16(b:Bytes, o:Int):Int
	...
	{
		var l = Int64.getLow(v);
		var h = Int64.getHigh(v);
		b.set(o, l & 0xFF);
		b.set(o + 1, (l >> 8) & 0xFF);
		b.set(o + 2, (l >> 16) & 0xFF);
		b.set(o + 3, (l >> 24) & 0xFF);
